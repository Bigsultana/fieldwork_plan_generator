...
describe("PowerPoint generation", () => {
  it("creates a valid zipped PPTX payload containing a map, schedule and supporting sheet", async () => {
    const project = { ...DEFAULT_PROJECT, projectTitle: "Test project", projectNumber: "TEST-001", clientName: "Test client" };
    const mapPlan = {
